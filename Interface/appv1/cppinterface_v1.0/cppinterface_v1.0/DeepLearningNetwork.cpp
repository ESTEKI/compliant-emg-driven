...
// Return Type  : void
//
void LSTMnet_DatasetF0_0::allocate()
{
...
// Return Type  : void
//
void LSTMnet_DatasetF0_0::cleanup()
{
  this->deallocate();
  for (int idx{0}; idx < 4; idx++) {
...
// Return Type  : void
//
void LSTMnet_DatasetF0_0::deallocate()
{
...
// Return Type  : void
//
void LSTMnet_DatasetF0_0::postsetup()
{
...
// Return Type  : void
//
void LSTMnet_DatasetF0_0::resetState()
{
...
// Return Type  : void
//
void LSTMnet_DatasetF0_0::setup()
{
  if (this->isInitialized) {
    ...
    (static_cast<MWRNNLayer *>(this->layers[1]))
        ->createRNNLayer(
            this->targetImpl, this->layers[0]->getOutputTensor(0), 3, 8, false,
            false, 0, 0, 0, "tanh", "sigmoid", 1,
            "./codegen/lib/LSTMnet_DatasetF/cnn_LSTMnet_DatasetF0_0_lstm_w.bin",
            "./codegen/lib/LSTMnet_DatasetF/cnn_LSTMnet_DatasetF0_0_lstm_b.bin",
            "./codegen/lib/LSTMnet_DatasetF/"
            "cnn_LSTMnet_DatasetF0_0_lstm_hx.bin",
            "./codegen/lib/LSTMnet_DatasetF/"
            "cnn_LSTMnet_DatasetF0_0_lstm_cx.bin",
            1);
    (static_cast<MWFCLayer *>(this->layers[2]))
        ->createFCLayer(
            this->targetImpl, this->layers[1]->getOutputTensor(0), 8, 1,
            "./codegen/lib/LSTMnet_DatasetF/cnn_LSTMnet_DatasetF0_0_fc_w.bin",
            "./codegen/lib/LSTMnet_DatasetF/cnn_LSTMnet_DatasetF0_0_fc_b.bin",
            0);
...
//
// Arguments    : void
// Return Type  : ::LSTMnet_DatasetF0_0
//
LSTMnet_DatasetF0_0::LSTMnet_DatasetF0_0()
{
  this->numLayers = 4;
...
// Return Type  : int
//
int LSTMnet_DatasetF0_0::getBatchSize()
{
...
// Return Type  : float *
//
float *LSTMnet_DatasetF0_0::getInputDataPointer(int b_index)
{
...
// Return Type  : float *
//
float *LSTMnet_DatasetF0_0::getInputDataPointer()
{
...
// Return Type  : float *
//
float *LSTMnet_DatasetF0_0::getLayerOutput(int layerIndex, int portIndex)
{
...
// Return Type  : int
//
int LSTMnet_DatasetF0_0::getLayerOutputSize(int layerIndex, int portIndex)
{
...
// Return Type  : float *
//
float *LSTMnet_DatasetF0_0::getOutputDataPointer(int b_index)
{
...
// Return Type  : float *
//
float *LSTMnet_DatasetF0_0::getOutputDataPointer()
{
...
// Return Type  : void
//
void LSTMnet_DatasetF0_0::predict()
{
  for (int idx{0}; idx < 4; idx++) {
...
// Return Type  : void
//
void LSTMnet_DatasetF0_0::setSize(int seqLength)
{
...
// Return Type  : void
//
void LSTMnet_DatasetF0_0::updateState()
{
...
//
namespace coder {
void DeepLearningNetwork_setup(LSTMnet_DatasetF0_0 *obj)
{
  obj->setup();
}
