...
/*
//ForCeTorqueMonitor.java is a pair program.
...
public:
	DataCollector()
		: emgSamples()
	{
		logFile.open(  "logFile" + to_string(elbowAngle) + "degLSTM.txt", std::fstream::out);//warning this will rewrite text file and erase previous recordings
