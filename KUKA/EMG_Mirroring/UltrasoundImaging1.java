 ...
 * @see #dispose()
 */
public class UltrasoundImaging1 extends RoboticsAPIApplication {
	@Inject
	...
	File myLogfile = new File("UltrasoundImaging1.txt");//**this file will be saved in \\172.31.1.147\krc\ApplicationServer
	FileWriter myWriter;
      ...
      //----------------control over Force with constant impedance    	   
     	...
     	desiredFrame.setGammaRad( (rollangle+initOrientation[2])*3.14/180);
         	...
         	try{
	    		...
	    		//startLoopTime = System.currentTimeMillis() ;
	    		udp.writeDatastr(recordStr+ "  " + String.valueOf(hz)+ "  " + String.valueOf(currentCartesanPosition.getZ() + desiredCartesianPose[1]));
