  ...
  if (this->isInitialized) {
    ...
    (static_cast<MWRNNLayer *>(this->layers[1]))
        ->createRNNLayer(this->targetImpl, this->layers[0]->getOutputTensor(0),
                         ...
                         "./codegen/lib/LSTMnet/"
                         "cnn_net2lstm_miladch235_netWork0_0_lstm_w.bin",
                         "./codegen/lib/LSTMnet/"
                         "cnn_net2lstm_miladch235_netWork0_0_lstm_b.bin",
                         "./codegen/lib/LSTMnet/"
                         "cnn_net2lstm_miladch235_netWork0_0_lstm_hx.bin",
                         "./codegen/lib/LSTMnet/"
                         "cnn_net2lstm_miladch235_netWork0_0_lstm_cx.bin",
                         1);
    (static_cast<MWFCLayer *>(this->layers[2]))
        ->createFCLayer(
            this->targetImpl, this->layers[1]->getOutputTensor(0), 128, 1,
            "./codegen/lib/LSTMnet/cnn_net2lstm_miladch235_netWork0_0_fc_w.bin",
            "./codegen/lib/LSTMnet/cnn_net2lstm_miladch235_netWork0_0_fc_b.bin",
            0);
...
// Return Type  : int
//
int net2lstm_miladch235_netWork0_0::getBatchSize()
{
...
// Return Type  : float *
//
float *net2lstm_miladch235_netWork0_0::getInputDataPointer(int b_index)
{
...
// Return Type  : float *
//
float *net2lstm_miladch235_netWork0_0::getInputDataPointer()
{
...
// Return Type  : float *
//
float *net2lstm_miladch235_netWork0_0::getLayerOutput(int layerIndex,
                                                      int portIndex)
{
...
// Return Type  : int
//
int net2lstm_miladch235_netWork0_0::getLayerOutputSize(int layerIndex,
                                                       int portIndex)
{
...
// Return Type  : float *
//
float *net2lstm_miladch235_netWork0_0::getOutputDataPointer(int b_index)
{
...
// Return Type  : float *
//
float *net2lstm_miladch235_netWork0_0::getOutputDataPointer()
{
...
//
// Arguments    : void
// Return Type  : ::net2lstm_miladch235_netWork0_0
//
...
// Return Type  : void
//
void net2lstm_miladch235_netWork0_0::setSize(int seqLength)
{
