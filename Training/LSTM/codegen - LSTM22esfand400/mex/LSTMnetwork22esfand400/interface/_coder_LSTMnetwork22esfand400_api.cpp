//
// _coder_LSTMnetwork22esfand400_api.cpp
//
// Code generation for function '_coder_LSTMnetwork22esfand400_api'
//
...
void LSTMnetwork22esfand400_api(const mxArray *prhs, const mxArray **plhs)
{
  ...
  y = LSTMnetwork22esfand400(&st, *x);
  // Marshall function outputs
  *plhs = emlrt_marshallOut(y);
}

// End of code generation (_coder_LSTMnetwork22esfand400_api.cpp)
