###########################################################################
## Makefile generated for component 'LSTMnet'. 
## 
## Makefile     : LSTMnet_rtw.mk
## Generated on : Sun Sep 26 16:43:02 2021
## Final product: .\LSTMnet.lib
...
PRODUCT_NAME              = LSTMnet
MAKEFILE                  = LSTMnet_rtw.mk
MATLAB_ROOT               = D:\Programs\MATLAB21\Polyspace
MATLAB_BIN                = D:\Programs\MATLAB21\Polyspace\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = E:\projects\New projects\myo armband\LSTM\codegen\lib\LSTMnet
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = LSTMnet_rtw_comp.rsp
CMD_FILE                  = LSTMnet_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = LSTMnet.lib
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=LSTMnet
...
LSTMnet_data.obj : $(START_DIR)\LSTMnet_data.cpp
	$(CPP) $(CPPFLAGS) -Fo"$@" $(START_DIR)\LSTMnet_data.cpp


LSTMnet_initialize.obj : $(START_DIR)\LSTMnet_initialize.cpp
	$(CPP) $(CPPFLAGS) -Fo"$@" $(START_DIR)\LSTMnet_initialize.cpp


LSTMnet_terminate.obj : $(START_DIR)\LSTMnet_terminate.cpp
	$(CPP) $(CPPFLAGS) -Fo"$@" $(START_DIR)\LSTMnet_terminate.cpp


LSTMnet.obj : $(START_DIR)\LSTMnet.cpp
	$(CPP) $(CPPFLAGS) -Fo"$@" $(START_DIR)\LSTMnet.cpp
