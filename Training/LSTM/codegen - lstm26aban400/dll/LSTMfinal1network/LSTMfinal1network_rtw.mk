###########################################################################
## Makefile generated for component 'LSTMfinal1network'. 
## 
## Makefile     : LSTMfinal1network_rtw.mk
## Generated on : Mon Oct 18 17:51:27 2021
## Final product: .\LSTMfinal1network.dll
...
PRODUCT_NAME              = LSTMfinal1network
MAKEFILE                  = LSTMfinal1network_rtw.mk
MATLAB_ROOT               = D:\Programs\MATLAB21\Polyspace
MATLAB_BIN                = D:\Programs\MATLAB21\Polyspace\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = E:\projects\New projects\myo armband\LSTM\codegen\dll\LSTMfinal1network
TGT_FCN_LIB               = ISO_C++11
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = LSTMfinal1network_rtw_comp.rsp
CMD_FILE                  = LSTMfinal1network_rtw.rsp
...
DEFINES_ = -DBUILDING_LSTMFINAL1NETWORK
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=LSTMfinal1network
...
LSTMfinal1network_data.obj : $(START_DIR)\LSTMfinal1network_data.cpp
	$(CPP) $(CPPFLAGS) -Fo"$@" $(START_DIR)\LSTMfinal1network_data.cpp


LSTMfinal1network_initialize.obj : $(START_DIR)\LSTMfinal1network_initialize.cpp
	$(CPP) $(CPPFLAGS) -Fo"$@" $(START_DIR)\LSTMfinal1network_initialize.cpp


LSTMfinal1network_terminate.obj : $(START_DIR)\LSTMfinal1network_terminate.cpp
	$(CPP) $(CPPFLAGS) -Fo"$@" $(START_DIR)\LSTMfinal1network_terminate.cpp


LSTMfinal1network.obj : $(START_DIR)\LSTMfinal1network.cpp
	$(CPP) $(CPPFLAGS) -Fo"$@" $(START_DIR)\LSTMfinal1network.cpp
