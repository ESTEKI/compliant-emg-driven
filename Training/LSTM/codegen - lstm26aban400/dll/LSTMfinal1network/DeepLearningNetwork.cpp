...
void LSTMfinal1network0_0::setup()
{
  if (this->isInitialized) {
    ...
    (static_cast<MWFCLayer *>(this->layers[2]))
        ->createFCLayer(
            this->targetImpl, this->layers[1]->getOutputTensor(0), 256, 1,
            "./codegen/dll/LSTMfinal1network/cnn_LSTMfinal1network0_0_fc_w.bin",
            "./codegen/dll/LSTMfinal1network/cnn_LSTMfinal1network0_0_fc_b.bin",
            0);
