...
#include "LSTMfinal1network_mexutil.h"
  ...
  if (this->isInitialized) {
    ...
    (static_cast<MWRNNLayer *>(this->layers[1]))
        ->createRNNLayer(this->targetImpl, this->layers[0]->getOutputTensor(0),
                         3, 256, false, false, 0, 0, 0, "tanh", "sigmoid", 1,
                         "E:\\projects\\New projects\\myo "
                         "armband\\LSTM\\codegen\\mex\\LSTMfinal1network\\cnn_"
                         "LSTMfinal1network0_0_lstm_w.bin",
                         "E:\\projects\\New projects\\myo "
                         "armband\\LSTM\\codegen\\mex\\LSTMfinal1network\\cnn_"
                         "LSTMfinal1network0_0_lstm_b.bin",
                         "E:\\projects\\New projects\\myo "
                         "armband\\LSTM\\codegen\\mex\\LSTMfinal1network\\cnn_"
                         "LSTMfinal1network0_0_lstm_hx.bin",
                         "E:\\projects\\New projects\\myo "
                         "armband\\LSTM\\codegen\\mex\\LSTMfinal1network\\cnn_"
                         "LSTMfinal1network0_0_lstm_cx.bin",
                         1);
    (static_cast<MWFCLayer *>(this->layers[2]))
        ->createFCLayer(this->targetImpl, this->layers[1]->getOutputTensor(0),
                        ...
                        "E:\\projects\\New projects\\myo "
                        "armband\\LSTM\\codegen\\mex\\LSTMfinal1network\\cnn_"
                        "LSTMfinal1network0_0_fc_w.bin",
                        "E:\\projects\\New projects\\myo "
                        "armband\\LSTM\\codegen\\mex\\LSTMfinal1network\\cnn_"
                        "LSTMfinal1network0_0_fc_b.bin",
                        0);
...
int32_T LSTMfinal1network0_0::getBatchSize()
{
  return this->inputTensors[0]->getBatchSize();
}

real32_T *LSTMfinal1network0_0::getInputDataPointer(int32_T b_index)
{
  return (static_cast<MWTensor<real32_T> *>(this->inputTensors[b_index]))
      ->getData();
}

real32_T *LSTMfinal1network0_0::getInputDataPointer()
{
  return (static_cast<MWTensor<real32_T> *>(this->inputTensors[0]))->getData();
}

real32_T *LSTMfinal1network0_0::getLayerOutput(int32_T layerIndex,
                                               int32_T portIndex)
{
  return this->targetImpl->getLayerOutput(this->layers, layerIndex, portIndex);
}

int32_T LSTMfinal1network0_0::getLayerOutputSize(int32_T layerIndex,
                                                 int32_T portIndex)
{
...
real32_T *LSTMfinal1network0_0::getOutputDataPointer(int32_T b_index)
{
  return (static_cast<MWTensor<real32_T> *>(this->outputTensors[b_index]))
      ->getData();
}

real32_T *LSTMfinal1network0_0::getOutputDataPointer()
{
...
void LSTMfinal1network0_0::setSize(int32_T seqLength)
{
...
namespace coder {
void DeepLearningNetwork_setup(const emlrtStack *sp, LSTMfinal1network0_0 *obj)
{
  TRY_DL_ERROR_CHECK();
