...
// Return Type  : void
//
void LSTMnetwork17esfand4000_0::allocate()
{
...
// Return Type  : void
//
void LSTMnetwork17esfand4000_0::cleanup()
{
  this->deallocate();
  for (int idx{0}; idx < 4; idx++) {
...
// Return Type  : void
//
void LSTMnetwork17esfand4000_0::deallocate()
{
...
// Return Type  : void
//
void LSTMnetwork17esfand4000_0::postsetup()
{
...
// Return Type  : void
//
void LSTMnetwork17esfand4000_0::resetState()
{
...
// Return Type  : void
//
void LSTMnetwork17esfand4000_0::setup()
{
  if (this->isInitialized) {
    ...
    (static_cast<MWRNNLayer *>(this->layers[1]))
        ->createRNNLayer(this->targetImpl, this->layers[0]->getOutputTensor(0),
                         ...
                         "./codegen/lib/LSTMnetwork17esfand400/"
                         "cnn_LSTMnetwork17esfand4000_0_lstm_w.bin",
                         "./codegen/lib/LSTMnetwork17esfand400/"
                         "cnn_LSTMnetwork17esfand4000_0_lstm_b.bin",
                         "./codegen/lib/LSTMnetwork17esfand400/"
                         "cnn_LSTMnetwork17esfand4000_0_lstm_hx.bin",
                         "./codegen/lib/LSTMnetwork17esfand400/"
                         "cnn_LSTMnetwork17esfand4000_0_lstm_cx.bin",
                         1);
    (static_cast<MWFCLayer *>(this->layers[2]))
        ->createFCLayer(this->targetImpl, this->layers[1]->getOutputTensor(0),
                        8, 1,
                        "./codegen/lib/LSTMnetwork17esfand400/"
                        "cnn_LSTMnetwork17esfand4000_0_fc_w.bin",
                        "./codegen/lib/LSTMnetwork17esfand400/"
                        "cnn_LSTMnetwork17esfand4000_0_fc_b.bin",
                        0);
...
//
// Arguments    : void
// Return Type  : ::LSTMnetwork17esfand4000_0
//
LSTMnetwork17esfand4000_0::LSTMnetwork17esfand4000_0()
{
  this->numLayers = 4;
...
// Return Type  : int
//
int LSTMnetwork17esfand4000_0::getBatchSize()
{
...
// Return Type  : float *
//
float *LSTMnetwork17esfand4000_0::getInputDataPointer(int b_index)
{
...
// Return Type  : float *
//
float *LSTMnetwork17esfand4000_0::getInputDataPointer()
{
...
// Return Type  : float *
//
float *LSTMnetwork17esfand4000_0::getLayerOutput(int layerIndex, int portIndex)
{
...
// Return Type  : int
//
int LSTMnetwork17esfand4000_0::getLayerOutputSize(int layerIndex, int portIndex)
{
...
// Return Type  : float *
//
float *LSTMnetwork17esfand4000_0::getOutputDataPointer(int b_index)
{
...
// Return Type  : float *
//
float *LSTMnetwork17esfand4000_0::getOutputDataPointer()
{
...
// Return Type  : void
//
void LSTMnetwork17esfand4000_0::predict()
{
  for (int idx{0}; idx < 4; idx++) {
...
// Return Type  : void
//
void LSTMnetwork17esfand4000_0::setSize(int seqLength)
{
...
// Return Type  : void
//
void LSTMnetwork17esfand4000_0::updateState()
{
  (dynamic_cast<MWRNNLayer *>(this->layers[1]))->updateState();
}

//
// Arguments    : LSTMnetwork17esfand4000_0 *obj
// Return Type  : void
//
namespace coder {
void DeepLearningNetwork_setup(LSTMnetwork17esfand4000_0 *obj)
{
  obj->setup();
}
